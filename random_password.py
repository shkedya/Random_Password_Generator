...
length_password = int(input("Enter the number of characters/digits you want your password to have. "))
capital_chars = input("Do you want your password to have capitals? Enter y or yes for yes and n or no for no. ")
special_chars = input("Do you want your password to have special characters? e.g. @ or ! Enter y or yes for yes and n "
                      "or no for no. ")
...
if capital_chars == "y" or "yes" and special_chars == "n" or "no" and numbers == "n" or "no":
    ...
    print(password)
if capital_chars == "n" or "no" and special_chars == "y" or "yes" and numbers == "n" or "no":
    temp_var = characters + specials
    new_choice = random.sample(temp_var, length_password)
    password = "".join(new_choice)
    print(password)
if capital_chars == "n" or "no" and special_chars == "n" or "no" and numbers == "y" or "yes":
